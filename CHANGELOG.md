...
- 2026-07-29 · product · Opportunity Radar MVP: self-contained React/TS/Vite/Tailwind sub-app in `opportunity-radar/` (founder-authorized framework exception, scoped to that directory) — landing, dashboard, detail pages, search/filter/sort, transparent Opportunity Score, saved opportunities, settings, auth/Stripe-ready seams, 41 tests; all data demo-labeled; root site untouched. Rebuilt against the founder-supplied Google Stitch design package (archived in `opportunity-radar/design/stitch/`), which introduces a product-scoped **light** visual system — a flagged exception to dark-mode-first, see PROJECT_CONTEXT §16a. Docs: `docs/OPPORTUNITY_RADAR_MVP.md`.
